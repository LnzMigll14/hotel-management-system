      ...
      <div class="col-lg-6 col-md-6 mb-5 px-4">
        <div class="bg-white rounded shadow p-4">
          ...
          <a
            ...
            target="_blank"
            class="d-inline-block text-decoration-none text-dark"><i class="fa-solid fa-location-dot"></i> 123 San Pedro Street,
          ...
          <a
            href="tel:+639958874983"
            class="d-inline-block text-decoration-none text-dark mb-2">
            <i class="bi bi-telephone-fill"></i> +639958874983
          </a>
          
          <h5 class="mt-4">Email Us</h5>
          <a href="mailto: lanzmiguel14@gmail.com" class="d-inline-block text-decoration-none text-dark mb-2"> <i class="bi bi-envelope-fill"></i> lanzmiguel14@gmail.com</a>
          
          <h5 class="mt-4">Follow Us</h5>
            <a href="#" class="d-inline-block text-dark text-decoration-none fs-5 me-2"><i class="bi bi-twitter me-1"></i></a> 
            <a href="#" class="d-inline-block text-dark text-decoration-none fs-5 me-2"><i class="bi bi-facebook me-1"></i></a> 
            <a href="#" class="d-inline-block text-dark text-decoration-none fs-5"><i class="bi bi-instagram me-1"></i></a> 
        </div>
      </div>
